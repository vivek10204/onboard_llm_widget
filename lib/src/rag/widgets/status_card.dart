...
// CHANGES:
// 1. Changed 'Documents' string to 'Lines' since we are generating embeddings per line in the uploaded doc(s)
        ...
        child: Column(
          children: [
            ...
            if (stats != null) ...[
              const SizedBox(height: 8),
              Text(
                'Lines: ${stats!.documentCount} | Dimension: ${stats!.vectorDimension}',
