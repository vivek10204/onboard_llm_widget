...
// CHANGES:
// 1. Added FlutterGemma.uninstallModel() calls when deleting model.
// 2. Some renaming (example_embedding_model to em)
...
class EmbeddingModelDownloadService {
  ...
  Future<void> deleteModel() async {
    ...
    FlutterGemma.uninstallModel(model.filename);
    FlutterGemma.uninstallModel(model.tokenizerFilename);
  }
