...
class ChatMessageWidget extends StatelessWidget {
  ...
  Widget _buildAvatar() {
    ...
    String? avatarPath = box.read('chatAvatarImagePath');

    // validation: check if path is not null and not empty
    bool hasImage = avatarPath != null && avatarPath.isNotEmpty;

    return CircleAvatar(
      backgroundColor: const Color(0xFF1a4a7c),
      // CHANGED: Use AssetImage for bundled assets
      backgroundImage: hasImage ? AssetImage(avatarPath) : null,
      child: hasImage
          ? null
